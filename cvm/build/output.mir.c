...
unsigned char v34[257];
    ...
    memcpy(v0, (char[2]){1, 2}, 2);
memcpy(v1, (char[2]){1, 237}, 2);
memcpy(v2, (char[2]){1, 8}, 2);
memcpy(v3, (char[2]){1, 49}, 2);
memcpy(v4, (char[2]){1, 0}, 2);
memcpy(v5, (char[2]){1, 5}, 2);
memcpy(v6, (char[11]){10, 45, 45, 45, 45, 45, 45, 45, 45, 45, 10}, 11);
memcpy(v7, (char[2]){1, 6}, 2);
memcpy(v8, (char[2]){1, 88}, 2);
memcpy(v9, (char[2]){1, 32}, 2);
memcpy(v10, (char[4]){3, 32, 124, 32}, 4);
memcpy(v11, (char[15]){14, 73, 110, 118, 97, 108, 105, 100, 32, 105, 110, 112, 117, 116, 10}, 15);
memcpy(v12, (char[32]){31, 65, 108, 100, 114, 101, 97, 100, 121, 32, 115, 111, 109, 101, 116, 104, 105, 110, 103, 32, 112, 108, 97, 99, 101, 100, 32, 104, 101, 114, 101, 10}, 32);
memcpy(v13, (char[2]){1, 7}, 2);
memcpy(v14, (char[2]){1, 4}, 2);
memcpy(v15, (char[31]){30, 69, 110, 116, 101, 114, 32, 97, 32, 112, 111, 115, 105, 116, 105, 111, 110, 32, 116, 111, 32, 112, 108, 97, 121, 32, 105, 110, 32, 58, 32}, 31);
memcpy(v16, (char[2]){1, 79}, 2);
memcpy(v17, (char[2]){1, 3}, 2);
memcpy(v18, (char[2]){1, 10}, 2);
memcpy(v19, (char[2]){1, 1}, 2);
memcpy(v20, (char[10]){9, 32, 32, 32, 32, 32, 32, 32, 32, 32}, 10);
memcpy(v21, (char[2]){1, 88}, 2);
while(1) {
if (v0[0] != 1 || v19[0] != 1 || v0[1] >= v20[0]) abort();
                v22[0] = MIN(v20[0] - v0[1], v19[1]);
                memcpy(v22+1, v20+v0[1]+1, v22[0]);
if (v22[0] + v18[0] > 255) abort();
                                    v23[0] = v22[0] + v18[0];
                                    memcpy(v23+1, v22+1, v22[0]);
                                    memcpy(v23+v22[0]+1, v18+1, v18[0]);
if (v10[0] + v23[0] > 255) abort();
                                    v24[0] = v10[0] + v23[0];
                                    memcpy(v24+1, v10+1, v10[0]);
                                    memcpy(v24+v10[0]+1, v23+1, v23[0]);
if (v19[0] != 1 || v19[0] != 1 || v19[1] >= v20[0]) abort();
                v25[0] = MIN(v20[0] - v19[1], v19[1]);
                memcpy(v25+1, v20+v19[1]+1, v25[0]);
if (v25[0] + v24[0] > 255) abort();
                                    v26[0] = v25[0] + v24[0];
                                    memcpy(v26+1, v25+1, v25[0]);
                                    memcpy(v26+v25[0]+1, v24+1, v24[0]);
if (v10[0] + v26[0] > 255) abort();
                                    v27[0] = v10[0] + v26[0];
                                    memcpy(v27+1, v10+1, v10[0]);
                                    memcpy(v27+v10[0]+1, v26+1, v26[0]);
if (v4[0] != 1 || v19[0] != 1 || v4[1] >= v20[0]) abort();
                v28[0] = MIN(v20[0] - v4[1], v19[1]);
...
if (v5[0] != 1 || v19[0] != 1 || v5[1] >= v20[0]) abort();
                v30[0] = MIN(v20[0] - v5[1], v19[1]);
                memcpy(v30+1, v20+v5[1]+1, v30[0]);
if (v30[0] + v18[0] > 255) abort();
                                    v31[0] = v30[0] + v18[0];
                                    memcpy(v31+1, v30+1, v30[0]);
                                    memcpy(v31+v30[0]+1, v18+1, v18[0]);
if (v10[0] + v31[0] > 255) abort();
                                    v32[0] = v10[0] + v31[0];
                                    memcpy(v32+1, v10+1, v10[0]);
                                    memcpy(v32+v10[0]+1, v31+1, v31[0]);
if (v14[0] != 1 || v19[0] != 1 || v14[1] >= v20[0]) abort();
                v33[0] = MIN(v20[0] - v14[1], v19[1]);
                memcpy(v33+1, v20+v14[1]+1, v33[0]);
if (v33[0] + v32[0] > 255) abort();
                                    v34[0] = v33[0] + v32[0];
                                    memcpy(v34+1, v33+1, v33[0]);
                                    memcpy(v34+v33[0]+1, v32+1, v32[0]);
if (v10[0] + v34[0] > 255) abort();
                                    v35[0] = v10[0] + v34[0];
                                    memcpy(v35+1, v10+1, v10[0]);
                                    memcpy(v35+v10[0]+1, v34+1, v34[0]);
if (v17[0] != 1 || v19[0] != 1 || v17[1] >= v20[0]) abort();
                v36[0] = MIN(v20[0] - v17[1], v19[1]);
                memcpy(v36+1, v20+v17[1]+1, v36[0]);
...
v6[v6[0]+1] = 0; printf("%s", v6+1);
if (v2[0] != 1 || v19[0] != 1 || v2[1] >= v20[0]) abort();
                v38[0] = MIN(v20[0] - v2[1], v19[1]);
                memcpy(v38+1, v20+v2[1]+1, v38[0]);
if (v38[0] + v18[0] > 255) abort();
                                    v39[0] = v38[0] + v18[0];
                                    memcpy(v39+1, v38+1, v38[0]);
                                    memcpy(v39+v38[0]+1, v18+1, v18[0]);
if (v10[0] + v39[0] > 255) abort();
                                    v40[0] = v10[0] + v39[0];
                                    memcpy(v40+1, v10+1, v10[0]);
                                    memcpy(v40+v10[0]+1, v39+1, v39[0]);
if (v13[0] != 1 || v19[0] != 1 || v13[1] >= v20[0]) abort();
                v41[0] = MIN(v20[0] - v13[1], v19[1]);
                memcpy(v41+1, v20+v13[1]+1, v41[0]);
if (v41[0] + v40[0] > 255) abort();
                                    v42[0] = v41[0] + v40[0];
                                    memcpy(v42+1, v41+1, v41[0]);
                                    memcpy(v42+v41[0]+1, v40+1, v40[0]);
if (v10[0] + v42[0] > 255) abort();
                                    v43[0] = v10[0] + v42[0];
                                    memcpy(v43+1, v10+1, v10[0]);
                                    memcpy(v43+v10[0]+1, v42+1, v42[0]);
if (v7[0] != 1 || v19[0] != 1 || v7[1] >= v20[0]) abort();
                v44[0] = MIN(v20[0] - v7[1], v19[1]);
...
v47[0] = 1; v47[1] = v46[0];
if (v47[0] == v19[0] && memcmp(v47+1, v19+1, v47[0]) == 0) {
...
memcpy(v48, v19, v19[0]+1); goto fn1;
} else { 
...
v50[0] = v46[0]; for (unsigned char index = 0; index < v46[0]; index++) {
                            v50[index+1] = v46[index+1] - v3[(index % v3[0])+1];
                        }

                if (v50[0] != 1 || v19[0] != 1 || v50[1] >= v20[0]) abort();
                v52[0] = MIN(v20[0] - v50[1], v19[1]);
                memcpy(v52+1, v20+v50[1]+1, v52[0]);
if (v52[0] == v9[0] && memcmp(v52+1, v9+1, v52[0]) == 0) {

} else { 
memcpy(v51, v19, v19[0]+1); goto fn2; 
}
v53[0] = 1; v53[1] = v21[0];
...
while(1) {
if (v62[0] == v17[0] && memcmp(v62+1, v17+1, v62[0]) == 0) {
break;
} else { 
...
v62[0] = v62[0]; for (unsigned char index = 0; index < v62[0]; index++) {
                            v62[index+1] = v62[index+1] + v19[(index % v19[0])+1];
                        }
if (v63[0] != 1 || v19[0] != 1 || v63[1] >= v60[0]) abort();
                v64[0] = MIN(v60[0] - v63[1], v19[1]);
...
if (v65[0] != 1 || v19[0] != 1 || v65[1] >= v60[0]) abort();
                v66[0] = MIN(v60[0] - v65[1], v19[1]);
                memcpy(v66+1, v60+v65[1]+1, v66[0]);
v67[0] = v63[0]; for (unsigned char index = 0; index < v63[0]; index++) {
                            v67[index+1] = v63[index+1] + v17[(index % v17[0])+1];
                        }
if (v67[0] != 1 || v19[0] != 1 || v67[1] >= v60[0]) abort();
                v68[0] = MIN(v60[0] - v67[1], v19[1]);
...
if (v71[0] == v2[0] && memcmp(v71+1, v2+1, v71[0]) == 0) {
...
v72[0] = v63[0]; for (unsigned char index = 0; index < v63[0]; index++) {
                            v72[index+1] = v63[index+1] * v17[(index % v17[0])+1];
                        }
v73[0] = v72[0]; for (unsigned char index = 0; index < v72[0]; index++) {
                            v73[index+1] = v72[index+1] + v0[(index % v0[0])+1];
                        }
if (v73[0] != 1 || v19[0] != 1 || v73[1] >= v60[0]) abort();
                v74[0] = MIN(v60[0] - v73[1], v19[1]);
                memcpy(v74+1, v60+v73[1]+1, v74[0]);
v75[0] = v72[0]; for (unsigned char index = 0; index < v72[0]; index++) {
                            v75[index+1] = v72[index+1] + v19[(index % v19[0])+1];
                        }
if (v75[0] != 1 || v19[0] != 1 || v75[1] >= v60[0]) abort();
                v76[0] = MIN(v60[0] - v75[1], v19[1]);
...
if (v72[0] != 1 || v19[0] != 1 || v72[1] >= v60[0]) abort();
                v78[0] = MIN(v60[0] - v72[1], v19[1]);
...
if (v79[0] == v2[0] && memcmp(v79+1, v2+1, v79[0]) == 0) {
memcpy(v61, v8, v8[0]+1); goto fn3;
} else { 
...
if (v2[0] != 1 || v19[0] != 1 || v2[1] >= v60[0]) abort();
                v80[0] = MIN(v60[0] - v2[1], v19[1]);
                memcpy(v80+1, v60+v2[1]+1, v80[0]);
if (v14[0] != 1 || v19[0] != 1 || v14[1] >= v60[0]) abort();
                v81[0] = MIN(v60[0] - v14[1], v19[1]);
                memcpy(v81+1, v60+v14[1]+1, v81[0]);
v82[0] = v81[0]; for (unsigned char index = 0; index < v81[0]; index++) {
                            v82[index+1] = v81[index+1] + v80[(index % v80[0])+1];
                        }
if (v4[0] != 1 || v19[0] != 1 || v4[1] >= v60[0]) abort();
                v83[0] = MIN(v60[0] - v4[1], v19[1]);
...
if (v84[0] == v2[0] && memcmp(v84+1, v2+1, v84[0]) == 0) {
memcpy(v61, v8, v8[0]+1); goto fn3;
} else { 
...
if (v7[0] != 1 || v19[0] != 1 || v7[1] >= v60[0]) abort();
                v85[0] = MIN(v60[0] - v7[1], v19[1]);
                memcpy(v85+1, v60+v7[1]+1, v85[0]);
if (v14[0] != 1 || v19[0] != 1 || v14[1] >= v60[0]) abort();
                v86[0] = MIN(v60[0] - v14[1], v19[1]);
                memcpy(v86+1, v60+v14[1]+1, v86[0]);
v87[0] = v86[0]; for (unsigned char index = 0; index < v86[0]; index++) {
                            v87[index+1] = v86[index+1] + v85[(index % v85[0])+1];
                        }
if (v0[0] != 1 || v19[0] != 1 || v0[1] >= v60[0]) abort();
                v88[0] = MIN(v60[0] - v0[1], v19[1]);
                memcpy(v88+1, v60+v0[1]+1, v88[0]);
v89[0] = v88[0]; for (unsigned char index = 0; index < v88[0]; index++) {
                            v89[index+1] = v88[index+1] + v87[(index % v87[0])+1];
                        }
if (v89[0] == v2[0] && memcmp(v89+1, v2+1, v89[0]) == 0) {
memcpy(v61, v8, v8[0]+1); goto fn3;
} else { 
...
if (v94[0] != 1 || v19[0] != 1 || v94[1] >= v60[0]) abort();
                v95[0] = MIN(v60[0] - v94[1], v19[1]);
                memcpy(v95+1, v60+v94[1]+1, v95[0]);
v94[0] = v94[0]; for (unsigned char index = 0; index < v94[0]; index++) {
                            v94[index+1] = v94[index+1] + v19[(index % v19[0])+1];
                        }
if (v95[0] == v9[0] && memcmp(v95+1, v9+1, v95[0]) == 0) {
memcpy(v92, v19, v19[0]+1); goto fn4;
} else { 
...
if (v51[0] == v19[0] && memcmp(v51+1, v19+1, v51[0]) == 0) {
v12[v12[0]+1] = 0; printf("%s", v12+1);
continue;
} else { 
 
}
if (v21[0] == v16[0] && memcmp(v21+1, v16+1, v21[0]) == 0) {
memcpy(v21, (char[2]){1, 88}, 2);
} else { 
