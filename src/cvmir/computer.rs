...
fn optimize_try() {
    let mut code = vec![
        IrAsm::Cst(102, vec![7]),
        IrAsm::Cst(369, vec![32]),
        IrAsm::Cst(147, vec![9]),
        IrAsm::Cst(
            139,
            vec![
                73, 110, 118, 97, 108, 105, 100, 32, 105, 110, 112, 117, 116, 10,
            ],
        ),
        IrAsm::Cst(114, vec![6]),
        IrAsm::Cst(284, vec![237]),
        IrAsm::Cst(359, vec![32, 104, 97, 115, 32, 119, 111, 110, 33, 10]),
        IrAsm::Cst(
            123,
            vec![
                69, 110, 116, 101, 114, 32, 97, 32, 112, 111, 115, 105, 116, 105, 111, 110, 32,
                116, 111, 32, 112, 108, 97, 121, 32, 105, 110, 32, 58, 32,
            ],
        ),
        IrAsm::Cst(300, vec![2]),
        IrAsm::Cst(247, vec![1]),
        IrAsm::Cst(
            410,
            vec![
                65, 108, 100, 114, 101, 97, 100, 121, 32, 115, 111, 109, 101, 116, 104, 105, 110,
                103, 32, 112, 108, 97, 99, 101, 100, 32, 104, 101, 114, 101, 10,
            ],
        ),
        IrAsm::Cst(224, vec![3]),
        IrAsm::Cst(98, vec![32, 124, 32]),
        IrAsm::Cst(281, vec![88]),
        IrAsm::Cst(394, vec![0]),
        IrAsm::Cst(180, vec![49]),
        IrAsm::Cst(89, vec![10]),
        IrAsm::Cst(273, vec![8]),
        IrAsm::Cst(61, vec![4]),
        IrAsm::Cst(146, vec![49, 50, 51, 52, 53, 54, 55, 56, 57]),
        IrAsm::Cst(49, vec![5]),
        IrAsm::Cst(292, vec![79]),
        IrAsm::Cst(84, vec![45, 45, 45, 45, 45, 45, 45, 45, 45, 10]),
        IrAsm::Cst(
            400,
            vec![78, 111, 98, 111, 100, 121, 32, 119, 111, 110, 33, 10],
        ),
        IrAsm::Cst(2, vec![32, 32, 32, 32, 32, 32, 32, 32, 32]),
        IrAsm::Cst(4, vec![88]),
        IrAsm::Loop(vec![
            IrAsm::Read(9, 2, 300, 247),
            IrAsm::Op(OperationType::Merge, 13, 9, 89),
            IrAsm::Op(OperationType::Merge, 17, 98, 13),
            IrAsm::Read(21, 2, 247, 247),
            IrAsm::Op(OperationType::Merge, 25, 21, 17),
            IrAsm::Op(OperationType::Merge, 29, 98, 25),
            IrAsm::Read(33, 2, 394, 247),
            IrAsm::Op(OperationType::Merge, 37, 33, 29),
            IrAsm::Prt(37),
            IrAsm::Prt(84),
            IrAsm::Read(50, 2, 49, 247),
            IrAsm::Op(OperationType::Merge, 54, 50, 89),
            IrAsm::Op(OperationType::Merge, 58, 98, 54),
            IrAsm::Read(62, 2, 61, 247),
            IrAsm::Op(OperationType::Merge, 66, 62, 58),
            IrAsm::Op(OperationType::Merge, 70, 98, 66),
            IrAsm::Read(74, 2, 224, 247),
            IrAsm::Op(OperationType::Merge, 78, 74, 70),
            IrAsm::Prt(78),
            IrAsm::Prt(84),
            IrAsm::Read(91, 2, 273, 247),
            IrAsm::Op(OperationType::Merge, 95, 91, 89),
            IrAsm::Op(OperationType::Merge, 99, 98, 95),
            IrAsm::Read(103, 2, 102, 247),
            IrAsm::Op(OperationType::Merge, 107, 103, 99),
            IrAsm::Op(OperationType::Merge, 111, 98, 107),
            IrAsm::Read(115, 2, 114, 247),
            IrAsm::Op(OperationType::Merge, 119, 115, 111),
            IrAsm::Prt(119),
            IrAsm::Prt(123),
            IrAsm::Inp(125),
            IrAsm::Prt(89),
            ...
            IrAsm::If(
                131,
                247,
                vec![IrAsm::Cst(135, vec![0])],
                vec![IrAsm::Cst(135, vec![1])],
            ),
            IrAsm::Mov(134, 135),
            IrAsm::If(134, 247, vec![IrAsm::Prt(139), IrAsm::Continue()], vec![]),
            IrAsm::Mov(125, 125),
            IrAsm::FunctionBlock(
                145,
                vec![
                    IrAsm::Cst(151, vec![0]),
                    IrAsm::Loop(vec![
                        IrAsm::If(147, 151, vec![IrAsm::Break()], vec![]),
                        IrAsm::Read(153, 146, 151, 247),
                        IrAsm::Op(OperationType::Add, 151, 151, 247),
                        IrAsm::If(
                            153,
                            125,
                            vec![IrAsm::Cst(164, vec![1])],
                            vec![IrAsm::Cst(164, vec![0])],
                        ),
                        IrAsm::Mov(163, 164),
                        IrAsm::If(163, 247, vec![IrAsm::Return(247)], vec![]),
                    ]),
                    IrAsm::Return(394),
                ],
            ),
            IrAsm::If(
                145,
                394,
                vec![IrAsm::Cst(171, vec![1])],
                vec![IrAsm::Cst(171, vec![0])],
            ),
            IrAsm::Mov(168, 171),
            IrAsm::If(168, 247, vec![IrAsm::Prt(139), IrAsm::Continue()], vec![]),
            IrAsm::Op(OperationType::Sub, 181, 125, 180),
            IrAsm::FunctionBlock(
                185,
                vec![
                    IrAsm::Read(187, 2, 181, 247),
                    IrAsm::If(
                        187,
                        369,
                        vec![IrAsm::Cst(192, vec![0])],
                        vec![IrAsm::Cst(192, vec![1])],
                    ),
                    IrAsm::Mov(191, 192),
                    IrAsm::If(191, 247, vec![IrAsm::Return(247)], vec![]),
                    IrAsm::Len(196, 4),
                    IrAsm::Op(OperationType::Add, 198, 181, 196),
                    IrAsm::Len(202, 2),
                    IrAsm::Read(204, 2, 198, 202),
                    IrAsm::Op(OperationType::Merge, 206, 4, 204),
                    IrAsm::Op(OperationType::Sub, 211, 181, 394),
                    IrAsm::Read(210, 2, 394, 211),
                    IrAsm::Op(OperationType::Merge, 2, 210, 206),
                    IrAsm::FunctionBlock(
                        221,
                        vec![
                            IrAsm::Cst(222, vec![0]),
                            IrAsm::Loop(vec![
                                IrAsm::If(222, 224, vec![IrAsm::Break()], vec![]),
                                IrAsm::Mov(226, 222),
                                IrAsm::Op(OperationType::Add, 222, 222, 247),
                                IrAsm::Read(233, 2, 226, 247),
                                IrAsm::If(
                                    233,
                                    369,
                                    vec![IrAsm::Cst(238, vec![1])],
                                    vec![IrAsm::Cst(238, vec![0])],
                                ),
                                IrAsm::Mov(237, 238),
                                IrAsm::If(237, 247, vec![IrAsm::Continue()], vec![]),
                                IrAsm::Op(OperationType::Add, 242, 226, 114),
                                IrAsm::Read(246, 2, 242, 247),
                                IrAsm::Op(OperationType::Add, 251, 226, 224),
                                IrAsm::Read(255, 2, 251, 247),
                                IrAsm::Op(OperationType::Add, 259, 255, 246),
                                IrAsm::Read(263, 2, 226, 247),
                                IrAsm::Op(OperationType::Add, 240, 263, 259),
                                IrAsm::If(
                                    240,
                                    273,
                                    vec![IrAsm::Cst(279, vec![1])],
                                    vec![IrAsm::Cst(279, vec![0])],
                                ),
                                IrAsm::Mov(278, 279),
                                IrAsm::If(278, 247, vec![IrAsm::Return(281)], vec![]),
                                IrAsm::If(
                                    240,
                                    284,
                                    vec![IrAsm::Cst(290, vec![1])],
                                    vec![IrAsm::Cst(290, vec![0])],
                                ),
                                IrAsm::Mov(289, 290),
                                IrAsm::If(289, 247, vec![IrAsm::Return(292)], vec![]),
                                IrAsm::Op(OperationType::Mul, 293, 226, 224),
                                IrAsm::Op(OperationType::Add, 301, 293, 300),
                                IrAsm::Read(305, 2, 301, 247),
                                IrAsm::Op(OperationType::Add, 310, 293, 247),
                                IrAsm::Read(314, 2, 310, 247),
                                IrAsm::Op(OperationType::Add, 318, 314, 305),
                                IrAsm::Read(322, 2, 293, 247),
                                IrAsm::Op(OperationType::Add, 299, 322, 318),
                                IrAsm::If(
                                    299,
                                    273,
                                    vec![IrAsm::Cst(338, vec![1])],
                                    vec![IrAsm::Cst(338, vec![0])],
                                ),
                                IrAsm::Mov(337, 338),
                                IrAsm::If(337, 247, vec![IrAsm::Return(281)], vec![]),
                                IrAsm::If(
                                    299,
                                    284,
                                    vec![IrAsm::Cst(349, vec![1])],
                                    vec![IrAsm::Cst(349, vec![0])],
                                ),
                                IrAsm::Mov(348, 349),
                                IrAsm::If(348, 247, vec![IrAsm::Return(292)], vec![]),
                            ]),
                            IrAsm::Return(369),
                        ],
                    ),
                    ...
                    IrAsm::If(
                        220,
                        369,
                        vec![IrAsm::Cst(355, vec![0])],
                        vec![IrAsm::Cst(355, vec![1])],
                    ),
                    IrAsm::Mov(354, 355),
                    IrAsm::If(
                        354,
                        247,
                        vec![
                            IrAsm::Op(OperationType::Merge, 363, 220, 359),
                            IrAsm::Prt(363),
                            IrAsm::End,
                        ],
                        vec![],
                    ...
                    IrAsm::FunctionBlock(
                        ...
                        vec![
                            ...
                            IrAsm::Cst(376, vec![0]),
                            IrAsm::Loop(vec![
                                IrAsm::If(372, 376, vec![IrAsm::Break()], vec![]),
                                IrAsm::Read(378, 371, 376, 247),
                                IrAsm::Op(OperationType::Add, 376, 376, 247),
                                IrAsm::If(
                                    378,
                                    369,
                                    vec![IrAsm::Cst(389, vec![1])],
                                    vec![IrAsm::Cst(389, vec![0])],
                                ),
                                IrAsm::Mov(388, 389),
                                IrAsm::If(388, 247, vec![IrAsm::Return(247)], vec![]),
                            ]),
                            IrAsm::Return(394),
                        ],
                    ),
                    IrAsm::If(
                        370,
                        394,
                        vec![IrAsm::Cst(396, vec![1])],
                        vec![IrAsm::Cst(396, vec![0])],
                    ),
                    IrAsm::Mov(393, 396),
                    IrAsm::If(393, 247, vec![IrAsm::Prt(400), IrAsm::End], vec![]),
                    IrAsm::Return(394),
                ],
            ),
            IrAsm::If(185, 247, vec![IrAsm::Prt(410), IrAsm::Continue()], vec![]),
            IrAsm::If(
                4,
                292,
                vec![IrAsm::Cst(417, vec![1])],
                vec![IrAsm::Cst(417, vec![0])],
            ),
            IrAsm::Mov(416, 417),
            IrAsm::If(
                416,
                247,
                vec![IrAsm::Cst(4, vec![88])],
                vec![IrAsm::Cst(4, vec![79])],
            ),
        ]),
    ];
