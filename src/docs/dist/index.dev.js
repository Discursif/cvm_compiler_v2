...
(function () {
  ...
  var parentDiv = function parentDiv(e) {
    return e instanceof HTMLDivElement ? e : parentDiv(e.parentElement);
  };

  var docs = document.querySelectorAll(".close-docs");

  var _loop_2 = function _loop_2(doc) {
  ...
  var applyFilter = function applyFilter(e, filter) {
    if (e !== undefined) {
  ...
  var updateVis = function updateVis(e, b) {
  ...
  var filterElements = function filterElements(elements, filter) {
